...
//ListenerクラスのインスタンスがDIコンテナに登録されるようにするこれにより@EventListenerアノテーションのメソッドを、Spring Boot側が自動的に検出しイベント発生時に実行する
@Component
public class SignupEventListener {
	...
	@EventListener	//　イベント発生時に実行したいメソッドに対し付ける Eventクラス　通知を受け付けるクラスを引数に設定し、どのイベントの発生時か指定
